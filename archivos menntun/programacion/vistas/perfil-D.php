...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../config/styles/style-D.css">
</head>
...
<body>
    <section class="seccion-perfil-usuario">
        ...
        <div class="perfil-usuario-body">
            ...
            <div class="apartados">
                <a href="../vistas/subirnotas.php" class="boton-apart editnotas fa-solid fa-file-arrow-up mt-4"></a>
                <a href="../vistas/tablahorariodoc.php" class="boton-apart horarios fa-solid fa-school mt-4"></a>
                <a href="../vistas/MuroD.php" class="boton-apart devolverse fa-sharp fa-solid fa-arrow-left"></a>
            </div>
        </div>
    </section>