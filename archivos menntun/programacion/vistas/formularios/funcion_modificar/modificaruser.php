...
<body>
    ...
    $primer_nombre_doc = $_GET['primer_nombre_doc'];
    $segundo_nombre_doc = $_GET['segundo_nombre_doc'];
    $primer_apellido_doc = $_GET['primer_apellido_doc'];
    $segundo_apellido_doc = $_GET['segundo_apellido_doc'];
    $correo_doc = $_GET['correo_doc'];
    ...
    $docenteasignatura = "SELECT * from asignatura WHERE asignatura= '$cod_asignatura'";
    $resultadoasignatura = mysqli_query($con, $docenteasignatura);
        ...
        <div class="card-body px-sm-4 px-0">
            <div class="row justify-content-center mb-5">
                <div class="col-md-10 col">
                    <h2 class="font-weight-bold ml-md-0 mx-auto text-center text-sm-left">Modificar Docente</h2>
                    <p class="mt-md-4 ml-md-0 ml-2 text-center text-lg-left">
                        Por favor, complete este formulario para modificar a un Docente.</p>
                </div>
            </div>
                ...
                <div class="col-lg-10 col-md-12">
                    <div class="card shadow-lg card-1">
                        <div class="card-body inner-card" style="margin-top: 15px;margin-bottom: 15px;">
                            <form action="../../../controlador/fun_modi/modificar.php" method="post">
                                    ...
                                    <tr>
                                        ...
                                        <div class="col-lg-5 col-md-6 col-sm-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="primer_nombre_doc" id="primer_nombre_doc" value="<?= $primer_nombre_doc ?>">
                                            </div>
                                            <div class="form-group">
                                                <label for="primer_apellido_doc" class="form-label">Primer apellido</label>
                                                <input type="text" class="form-control" name="primer_apellido_doc" id="primer_apellido_doc" value="<?= $primer_apellido_doc ?>">
                                            </div>
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                <label for="cod_cursos" class="form-label">Asignatura</label>
                                                <select class="form-control "name="cod_asignatura">
                                                    <!--indico el ciclo que me llena el select-->
                                                    <option selected value="<?php echo $arregloasignatura['cod_asignatura'] ?>"><?php echo $cod_asignatura ?></option>
                                        ...
                                        <div class="col-lg-5 col-md-6 col-sm-12">
                                                    ...
                                                    <input type="text" class="form-control" name="segundo_nombre_doc" id="segundo_nombre_doc" value="<?= $segundo_nombre_doc ?>">
                                                
                                                <div class="form-group">
                                                    <label for="segundo_apellido_doc" class="form-label">Segundo apellido</label>
                                                    <input type="text" class="form-control" name="segundo_apellido_doc" id="segundo_apellido_doc" value="<?= $segundo_apellido_doc ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="correo_doc" class="form-label">Correo electrónico</label>
                                                    <input type="email" class="form-control" name="correo_doc" id="correo_doc" value="<?= $correo_doc?>">
                                                </div>
                                                <div class="form-group">
                                                    <input type="hidden" class="form-control" name="id_documento_doc" id="id_documento_doc" inputmode="numeric" value="<?= $id_documento_doc ?>">
                                                </div>
                                                <div class="row d-flex justify-content-end mb-0">
                                                    <div class="col-lg-4 col-auto" style="margin-top: 30px;">
                                                        <button type="submit" value="Modificar" class="btn btn-dark text-center me-2" style="border-color:#23272b;" name="submit"  onclick="return validar_modif_docente(this.form)">Modificar</button>
                                                    </div>
                                                    <div class="col-lg-4 col-auto" style="margin-top: 30px;">
