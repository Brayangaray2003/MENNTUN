    ...
    <div class="card-body px-sm-4 px-0">
      <div class="row justify-content-center mb-5">
        <div class="col-md-10 col">
          <h2 class="font-weight-bold ml-md-0 mx-auto text-center text-sm-left">Registro Administrador</h2>
          <p class="mt-md-4 ml-md-0 ml-2 text-center text-lg-left">
            Por favor, complete este formulario para registrar a un Administrador.</p>
        </div>
      </div>
            ...
            <div class="card-body inner-card" style="margin-top: 15px;margin-bottom: 15px;">
              <div class="row justify-content-center">
                <div class="col-lg-5 col-md-6 col-sm-12">
                  <form action="../../../controlador/fun_registrer/controlador_regis_admin.php" method="post">
                    <div class="form-group">
                      <label for="primer_nombre_admin" class="form-label">Primer nombre</label>
                      <input type="text" class="form-control" name="primer_nombre_admin" id="primer_nombre_admin" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122))">
                    </div>
                    <div class="form-group">
                      <label for="segundo_nombre_admin" class="form-label">Segundo nombre</label>
                      <input type="text" class="form-control" name="segundo_nombre_admin" id="segundo_nombre_admin" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122))">
                    </div>
                    ...
                    <div class="form-group">
                      ...
                      <select class="form-control" name="cod_rol">
                        <option value="302">Administrador</option>
                      </select>
                    </div>
                </div>
                ...
                <div class="col-lg-5 col-md-6 col-sm-12">
                  <div class="form-group">
                    <label for="primer_apellido_admin" class="form-label">Pirmer apellido</label>
                    <input type="text" class="form-control" name="primer_apellido_admin" id="primer_apellido_admin" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122))">
                  </div>
                  <div class="form-group">
                    <label for="segundo_apellido_admin" class="form-label">Segundo apellido</label>
                    <input type="text" class="form-control" name="segundo_apellido_admin" id="segundo_apellido_admin" onkeypress="return ((event.charCode >= 65 && event.charCode <= 90) || (event.charCode >= 97 && event.charCode <= 122))">
                  </div>
                  <div class="form-group">
                    <label for="cod_admin" class="form-label">Número documento</label>
                    <input type="number" class="form-control" name="cod_admin" id="cod_admin">
                  </div>
                  ...
                  <di>
                    ...
                    <div class="row d-flex justify-content-end mb-0">
                      <div class="col-lg-4 col-auto" style="margin-top: 30px;">
                        <button type="submit" value="Agregar" class="btn btn-dark text-center" style="border-color:#23272b;" name="submit" onclick="return validar_regi_admin(this.form)">Agregar</button>
                      </div>
                      <div class="col-lg-4 col-auto" style="margin-top: 30px;">
