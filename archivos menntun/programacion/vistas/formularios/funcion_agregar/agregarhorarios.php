        ...
        <div class="card-body px-sm-4 px-0">
            <div class="row justify-content-center mb-5">
                <div class="col-md-10 col">
                    <h2 class="font-weight-bold ml-md-0 mx-auto text-center text-sm-left">Agregar Horario</h2>
                    <p class="mt-md-4 ml-md-0 ml-2 text-center text-lg-left">
                        Por favor, complete este formulario para registrar una nuevo horario al docente.</p>
                </div>
            </div>
                        ...
                        <div class="card-body inner-card" style="margin-top: 15px;margin-bottom: 15px;">
                            <div class="row justify-content-center">
                                <div class="col-lg-5 col-md-6 col-sm-12">
                                    <form action="../../../controlador/fun_insertar/insertarhorarios.php" method="post">
                                        <div class="form-group">
                                            <label for="horario_inicial" class="form-label">Horario inicial</label>
                                            <input type="time" name="horario_inicial" class="form-control" id="horario_inicial">
                                        </div>
                                        <div class="form-group">
                                            <label for="horario_final" class="form-label">Horario final</label>
                                            <input type="time" name="horario_final" class="form-control" id="horario_final">
                                        </div>
                                        <div class="form-group">
                            ...
                            <div class="row d-flex justify-content-center mb-0">
                                <div class="col-lg-4 col-auto" style="margin-top: 30px;max-width: 120px;">
                                    <button type="submit" value="Agregar" class="btn btn-dark text-center" style="border-color:#23272b;" name="submit" onclick="return validar_agreg_horario(this.form)" >Agregar</button>
                                </div>
