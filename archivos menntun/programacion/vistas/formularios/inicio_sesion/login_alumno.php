            ...
            <div class="row justify-content-center my-auto">
              <div class="col-md-8 col-10 my-5">
                ...
                <div class="form-group">
                  <form action="../../../controlador/fun_login/controlador_alumno.php" method="post">

                    <label for="usuario" class="form-label text-muted">Correo electrónico</label>
                ...
                <div class="row justify-content-center my-3 px-3">
                  <input type="submit" class="btn form-control btn-block btn-color" name="btningresar" value="Ingresar"  onclick="return validar_login_usuario(this.form)">
                </div>
