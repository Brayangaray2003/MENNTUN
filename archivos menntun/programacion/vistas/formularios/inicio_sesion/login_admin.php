        ...
        <div class="d-flex flex-lg-row flex-column-reverse">
            ...
            <div class="row justify-content-center my-auto">
              <div class="col-md-8 col-10 my-5">
                ...
                <div class="form-group">
                  <form action="../../../controlador/fun_login/controlador_admin.php" method="post">

                    <label for="administrador" class="form-label text-muted">Correo electrónico</label>
                    <input type="email" class="form-control" name="administrador" id="administrador" required>
                </div>
                ...
                <div class="row justify-content-center my-3 px-3">
                  <input type="submit" class="btn form-control btn-block btn-color" name="btningresar" value="Ingresar" onclick="return validar_login_admin(this.form)">
                </div>
              </div>
            </div>
          </div>
          <div class="card card2">
            <div class="my-auto mx-md-5 px-md-5 right">
              ...
              <h6 class="text-white">Nos agrada ser parte de su labor.</h6>
