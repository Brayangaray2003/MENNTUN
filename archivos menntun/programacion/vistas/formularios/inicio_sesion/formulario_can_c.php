      ...
      <div class="d-flex flex-lg-row flex-column-reverse">
            ...
            <div class="col-md-8 col-10 my-5">
              ...
              <div class="form-group">
                <form action="" method="post">
                  ...
                  <input type="email" class="form-control"  name="correoRe" required/>
              </div>

              <div class="form-group">
              <form action="" method="post">
                <label for="password" class="form-control-label text-muted">Contraseña</label>
                <input type="password" class="form-control"  name="contraseña_alum" required/>
              </div>
              <div class="form-group">
              <form action="" method="post">
              ...
              <form action="" method="post">
              <input type="submit" class="btn form-control btn-block btn-color" value="confirmar" name="modificaCo"/>
              </div>
        ...
        <div class="card card2">
          <div class="my-auto mx-md-5 px-md-5 right">
            <h1 class="text-white">Estamos contigo Estudiante</h1>
            <h6 class="text-white">Seguimos en los procesos de mejora.</h6>
