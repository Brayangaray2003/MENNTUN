...
<head>
  ...
  <title>Recuperar contraseña Docente </title>
      ...
      <div class="d-flex flex-lg-row flex-column-reverse">
        <div class="card card1">
          <div class="row justify-content-center my-auto">
            <div class="col-md-8 col-10 my-5">
              ...
              <form method="post" action="correo_doc.php">

                  <label class="form-label text-muted">Correo electrónico</label>
                  <input type="email" class="form-control" name="correo_doc">
              </div>
              ...
              <form method="post" action="correo_doc.php">
                ...
                <input type="submit" class="btn form-control btn-block btn-color" name="submit" onclick="return validar_cambiar_contradoc(this.form)">
              </div>
            </div>
          </div>
        ...
        <div class="card card2">
          <div class="my-auto mx-md-5 px-md-5 right">
            ...
            <h6 class="text-white">Estamos contigo para hacer tu trabajo más fácil</h6>
