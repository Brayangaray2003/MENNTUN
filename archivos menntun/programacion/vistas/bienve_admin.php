...
if (!isset($_SESSION['primer_nombre_admin'])) {
    header("location: ../formularios/inicio_sesion/login_admin.php");
}
...
<head>
    ...
    <link rel="stylesheet" href="../config/styles/bienve_admin.css" type="text/css">
...
<body id="body-pd" style="margin-top: 0px;">
    ...
    <div>
        ...
        <div class="inner-header flex"></div>
            <h1>Bienvenido <?php echo $user. " ". $ape?></h1>
        </div>
    </div>
</body>