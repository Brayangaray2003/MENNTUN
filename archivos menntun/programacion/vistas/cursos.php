...
//Los registros
$query2 = "SELECT cursos.cod_cursos, cursos.curso, grado.grado, cursos.estado 
    FROM cursos INNER JOIN grado on cursos.cod_grado = grado.cod_grado";
...
<body id="body-pd" style="margin-top: 0px;">
    ...
    <h1 style="text-align:center;color:black;">Cursos</h1>
    <div style="margin-top: 55px;">
        <div>
            <div class="dt-buttons">
                <!--botón de agregar-->
                <div class="col-2 me-2 py-2" style="padding-left: 2px;padding-right: 9px;">
                    <a class="btn btn-dark" style="padding-right: 9px;padding-left: 10px;border-left-width: 1px;" href="../vistas/formularios/funcion_agregar/agregarcurso.php" role="button">
                        <i style="color:white;" class="bi bi-plus-circle-dotted"></i>
                    </a>
                    <!--botón de listar-->
                    <a href="../vistas/cursos.php" class="btn btn-dark" style="padding-left: 11px;padding-right: 10px;" type="submit" name="listar"><i style="color:white;" class="fas fa-spinner"></i></a>
                </div>
            </div>
        </div>
            ...
            <table id="myTable" class="table table-hover mx-auto">
                <thead style="background-color:#23272b">
                    <tr class="text-center">
                        <th class="text-nowrap text-light">Cod Curso</th>
                ...
                <tbody class="table-light text-black">
                    ...
                    ?>
                            <tr>
                                <td style="text-align: center;background-color: #FFFFFF"><?php echo $arreglo2['cod_cursos'] ?></td>
                                ...
                                <td style="text-align: center;background-color: #FFFFFF">
                                    <div class="mx-auto" style="max-width: 42px;">
                                        <?php
                                        if ($arreglo2['estado'] == 0) {
                                            echo '<a class="btn btn-link" name="eliminar" href="../controlador/fun_eliminar/eliminarcurso.php? 
                                    cod_cursos= ' . $arreglo2['cod_cursos'] . ' & estado= ' . $arreglo2['estado'] . '" role="button" onclick="return confirmacion()class="btn btn" style="color: #2e4f4f; border: none; font-size: 15px"><i class="bx bxs-user-check bx-flashing bx-sm"></i></a>';
                                        } elseif ($arreglo2['estado'] == 1) {
                                            echo '<a class="btn btn-link" name="eliminar" href="../controlador/fun_eliminar/eliminarcurso.php? 
                                    cod_cursos= ' . $arreglo2['cod_cursos'] . ' & estado= ' . $arreglo2['estado'] . '"" role="button" onclick="return confirmacion()class="btn btn" style="color: #2e4f4f; border: none; font-size: 15px"><i class="bx bxs-user-x bx-flashing bx-sm"></i></a>';
                                        }
                                        ?>
                                    </div>
                                </td>
